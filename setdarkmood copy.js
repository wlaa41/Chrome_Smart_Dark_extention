...
ripitition_counter=0;
let restartcounter = true
let repitiionAllowed = 100
...
function holdrepititiveUpdate(event){
        ...
        ripitition_counter+=1
        console.log('it is ok counter at '+ ripitition_counter)
        

        if(ripitition_counter < repitiionAllowed )
        {           
            ...
            if(restartcounter)
            {
                ...
                setTimeout(() => {            
                    ripitition_counter = 0
                    console.log('restarting counter '+ ripitition_counter)
                    restartcounter = true
                    repitiionAllowed =5 
                }, 2000);
            }
